...
func (_q *PlanQuery) QueryCreditGrants() *CreditGrantQuery {
...
func (_q *PlanQuery) WithCreditGrants(opts ...func(*CreditGrantQuery)) *PlanQuery {
	query := (&CreditGrantClient{config: _q.config}).Query()
...
func (_q *PlanQuery) loadCreditGrants(ctx context.Context, query *CreditGrantQuery, nodes []*Plan, init func(*Plan), assign func(*Plan, *CreditGrant)) error {
