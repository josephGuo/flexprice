...
func (_q *PaymentQuery) QueryAttempts() *PaymentAttemptQuery {
...
func (_q *PaymentQuery) WithAttempts(opts ...func(*PaymentAttemptQuery)) *PaymentQuery {
	query := (&PaymentAttemptClient{config: _q.config}).Query()
...
func (_q *PaymentQuery) loadAttempts(ctx context.Context, query *PaymentAttemptQuery, nodes []*Payment, init func(*Payment), assign func(*Payment, *PaymentAttempt)) error {
